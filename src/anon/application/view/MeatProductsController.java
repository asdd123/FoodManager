...
public class MeatProductsController implements Initializable {
	@FXML
	...
	@FXML
	private void scan() {
		boolean isListEmpty = application.getFoodDAO().getMeatAndEggsProductsData().isEmpty();
		String errorMsg = "";
		if (!isListEmpty) {

			for (Food food : application.getFoodDAO().getMeatAndEggsProductsData()) {
