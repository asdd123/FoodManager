...
public class SugarProductsController implements Initializable {
	@FXML
	...
	@FXML
	private void scan() {
		boolean isListEmpty = application.getFoodDAO().getSugarProductsData().isEmpty();
		String errorMsg = "";
		if (!isListEmpty) {

			for (Food food : application.getFoodDAO().getSugarProductsData()) {
