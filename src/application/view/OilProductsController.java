...
public class OilProductsController implements Initializable {
	@FXML
	...
	@FXML
	private void scan() {
		boolean isListEmpty = application.getFoodDAO().getOilProductsData().isEmpty();
		String errorMsg = "";
		if (!isListEmpty) {

			for (Food food : application.getFoodDAO().getOilProductsData()) {
